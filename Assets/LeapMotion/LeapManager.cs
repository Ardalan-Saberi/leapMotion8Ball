...
public class LeapManager : MonoBehaviour
{
	...
	public static float HandMinX = -20.0f;
	public static float HandMaxX = 20.0f;
	public static float HandMinY = -16.0f;
	public static float HandMaxY = 50.0f;
	public static float HandMinZ = -10.0f;
	public static float HandMaxZ = 12.0f;
	/*public static float HandMinX = -7.0f;
	public static float HandMaxX = 7.0f;
	public static float HandMinY = -6.0f;
	public static float HandMaxY = 16.0f;
	public static float HandMinZ = -6.0f;
	public static float HandMaxZ = 6.0f;*/
	 ...
	 */
		public static ArrayList forwardFacingFingers (Hand hand)
		{
				...
				foreach (Finger finger in hand.Fingers) {
						if (isForwardRelativeToHand (finger, hand)) {
								forwardFingers.Add (finger);
						}
				}
	 ...
	 */
		...
		public static bool isHandFisted (Hand hand)
		{
			//Finger forwardFinger = Finger.Invalid;
			ArrayList forwardFingers = forwardFacingFingers (hand);
			return forwardFingers.Count == 0;
		}
	 ...
	 */
		public Vector2[] getScreenFingerPositions (Hand hand)
		{
				...
				for (int i=0; i<hand.Fingers.Count; i++) {
						retArr [i] = leapPositionToScreen (hand.Fingers [i].TipPosition);
				}
	 ...
	 */
		public Vector3[] getWorldFingerPositions (Hand hand)
		{
				...
				for (int i=0; i<hand.Fingers.Count; i++) {
						retArr [i] = hand.Fingers [i].TipPosition.ToUnityTranslated ();
				}
